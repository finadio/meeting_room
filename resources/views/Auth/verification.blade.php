...
<head>
    ...
    <title>Booking Meeting Room | Verification Page</title>
    <link
        ...
        <div class="row">
            <div class="col-12 col-sm-6 login-section-wrapper mx-auto">
                <div class="brand-wrapper">
                    <img src="{{ asset('img/msa.png') }}" alt="logo" class="logo" />
                </div>
            ...
            <div class="col-sm-6 px-0 d-none d-sm-block" style="background-color: #ffffff">
                <img src="{{ asset('img/sakha_utama.png') }}" alt="login image" class="login-img" />
            </div>
        </div>
    </div>
</main>
