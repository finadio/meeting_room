                    ...
                    <form action="{{ route('admin.facilities.store') }}" method="post" enctype="multipart/form-data" class="facility-form">
                        ...
                        <div class="row mt-4 justify-content-center">
                            <div class="col-md-4 mb-2">
                                <button type="submit" class="btn btn-primary btn-lg w-90 custom-btn">
                                    <i class="bx bx-save me-2"></i>
                                    Create Facility
                                </button>

                                <button type="button" class="btn btn-secondary btn-lg w-90 custom-btn" onclick="goBack()">
...
<style>
    ...
    .custom-input, .custom-select, .custom-textarea {
        ...
        text-align-last: center;     /* Tambahan */
    }
