            ...
            <div class="col-lg-8 col-md-10">
                <div class="booking-card">
                    <div class="booking-header">
                        ...
                        <h3 class="header-title">Buat Pengguna Baru</h3>
                    ...
                    <div class="booking-content">
                        ...
                        <form action="{{ route('admin.users.store') }}" method="POST" enctype="multipart/form-data" class="booking-form">
                            @csrf
                            ...
                            <div class="form-section">
                                <div class="form-group-enhanced">
                                    ...
                                    <div class="input-wrapper">
                                        <input type="text" name="name" id="name" class="form-control-enhanced" value="{{ old('name') }}" placeholder="Masukkan nama lengkap" required>
                                ...
                                <div class="form-group-enhanced">
                                    ...
                                    <div class="input-wrapper">
                                        <input type="email" name="email" id="email" class="form-control-enhanced" value="{{ old('email') }}" placeholder="Masukkan alamat email" required>
                                        <div class="input-border"></div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group-enhanced">
                                    ...
                                    <div class="input-wrapper">
                                        <input type="text" name="contact_number" id="contact_number" class="form-control-enhanced" placeholder="Contoh: 6281234567890" required>
                                        <div class="input-border"></div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group-enhanced">
                                    ...
                                    <div class="input-wrapper">
                                        <select name="user_type" id="user_type" class="form-control-enhanced" required>
                                            <option value="user" {{ old('user_type') == 'user' ? 'selected' : '' }}>Pengguna</option>
                                ...
                                <div class="form-group-enhanced">
                                    ...
                                    <div class="input-wrapper password-input-wrapper">
                                        <input type="password" name="password" id="password" class="form-control-enhanced" placeholder="Masukkan password" required>
