            ...
            <div class="col-lg-8 col-md-10">
                <div class="booking-card">
                    <div class="booking-header">
                        ...
                        <h3 class="header-title">Detail Pengguna</h3>
                    ...
                    <div class="booking-content">
                        ...
                        <div class="user-details-grid">
                            <div class="display-group-enhanced">
                                ...
                                <p class="display-value">{{ $user->id }}</p>
                            </div>
                            ...
                            <div class="display-group-enhanced">
                                ...
                                <p class="display-value">{{ $user->name }}</p>
                            </div>
                            ...
                            <div class="display-group-enhanced">
                                ...
                                <p class="display-value">{{ $user->email }}</p>
                            </div>
                            ...
                            <div class="display-group-enhanced">
                                ...
                                <p class="display-value">{{ $user->contact_number ?? '-' }}</p>
                            </div>
                            ...
                            <div class="display-group-enhanced">
                                ...
                                <p class="display-value">{{ ucfirst($user->user_type) }}</p>
                            </div>
                            ...
                            <div class="display-group-enhanced">
                                ...
                                <div class="profile-picture-display">
                                    @if ($user->profile_picture && Storage::exists('public/profile_pictures/' . $user->profile_picture))
                                        <img src="{{ asset('storage/profile_pictures/' . $user->profile_picture) }}" alt="{{ $user->name }}'s Profile Picture" class="img-fluid rounded-circle profile-img">
                                    @else
                                        <img src="https://bootdey.com/img/Content/avatar/avatar1.png" alt="Default Profile Picture" class="img-fluid rounded-circle profile-img">
                                    @endif
                                </div>
                            </div>
                        </div>
